...
// ../../node_modules/@storybook/blocks/node_modules/@storybook/components/dist/OverlayScrollbars-VAV6LJAB.mjs
...
var import_overlayscrollbars = __toESM2(require_OverlayScrollbars());
var OverlayScrollbarsComponent = ({ options = {}, extensions, className, children, ...rest }) => {
  let osTargetRef = (0, import_react.useRef)(), osInstance = (0, import_react.useRef)();
  return (0, import_react.useEffect)(() => (osInstance.current = (0, import_overlayscrollbars.default)(osTargetRef.current, options, extensions), mergeHostClassNames(osInstance.current, className), () => {
  ...
  }, [options]), (0, import_react.useEffect)(() => {
    import_overlayscrollbars.default.valid(osInstance.current) && mergeHostClassNames(osInstance.current, className);
  }, [className]), import_react.default.createElement("div", { className: "os-host", ...rest, ref: osTargetRef }, import_react.default.createElement("div", { className: "os-resize-observer-host" }), import_react.default.createElement("div", { className: "os-padding" }, import_react.default.createElement("div", { className: "os-viewport" }, import_react.default.createElement("div", { className: "os-content" }, children))), import_react.default.createElement("div", { className: "os-scrollbar os-scrollbar-horizontal " }, import_react.default.createElement("div", { className: "os-scrollbar-track" }, import_react.default.createElement("div", { className: "os-scrollbar-handle" }))), import_react.default.createElement("div", { className: "os-scrollbar os-scrollbar-vertical" }, import_react.default.createElement("div", { className: "os-scrollbar-track" }, import_react.default.createElement("div", { className: "os-scrollbar-handle" }))), import_react.default.createElement("div", { className: "os-scrollbar-corner" }));
};
...
//# sourceMappingURL=OverlayScrollbars-VAV6LJAB-AI3G7R5J.js.map
