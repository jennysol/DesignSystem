...
function generateUnionElement({ name, value, elements, raw }) {
  return value != null ? value : elements != null ? elements.map(generateUnionElement).join(" | ") : raw != null ? raw : name;
}
...
//# sourceMappingURL=chunk-6FFAVYMH.js.map
