...
var require_get_substitution = __commonJS({
  "../../node_modules/core-js/internals/get-substitution.js"(exports, module) {
    ...
    var stringSlice4 = uncurryThis5("".slice);
    ...
    module.exports = function(matched, str, position2, captures, namedCaptures, replacement) {
      ...
      return replace3(replacement, symbols, function(match2, ch) {
        var capture;
        switch (charAt2(ch, 0)) {
          case "$":
            return "$";
          case "&":
            return matched;
          case "`":
            return stringSlice4(str, 0, position2);
          case "'":
          ...
          default:
            ...
            if (n2 > m2) {
              ...
              if (f2 === 0)
                return match2;
              if (f2 <= m2)
                return captures[f2 - 1] === void 0 ? charAt2(ch, 1) : captures[f2 - 1] + charAt2(ch, 1);
              return match2;
            }
...
var require_es_weak_map_constructor = __commonJS({
  "../../node_modules/core-js/modules/es.weak-map.constructor.js"() {
    ...
    var nativeSet = uncurryThis5(WeakMapPrototype.set);
    var hasMSEdgeFreezingBug = function() {
      return FREEZING && fails9(function() {
    ...
    if (NATIVE_WEAK_MAP) {
      if (IS_IE11) {
        ...
        nativeDelete = uncurryThis5(WeakMapPrototype["delete"]);
        nativeHas = uncurryThis5(WeakMapPrototype.has);
        nativeGet = uncurryThis5(WeakMapPrototype.get);
...
var require_es_global_this = __commonJS({
  "../../node_modules/core-js/modules/es.global-this.js"() {
    ...
    var global3 = require_global();
    $9({ global: true, forced: global3.globalThis !== global3 }, {
      globalThis: global3
    });
  }
});
...
var require_regexp_get_flags = __commonJS({
  "../../node_modules/core-js/internals/regexp-get-flags.js"(exports, module) {
    ...
    module.exports = function(R) {
      var flags = R.flags;
      return flags === void 0 && !("flags" in RegExpPrototype3) && !hasOwn2(R, "flags") && isPrototypeOf2(RegExpPrototype3, R) ? call2(regExpFlags, R) : flags;
    };
  }
});
...
var require_string_repeat = __commonJS({
  "../../node_modules/core-js/internals/string-repeat.js"(exports, module) {
    ...
    module.exports = function repeat2(count) {
      var str = toString3(requireObjectCoercible2(this));
      var result = "";
...
var require_create_html = __commonJS({
  "../../node_modules/core-js/internals/create-html.js"(exports, module) {
    ...
    module.exports = function(string, tag, attribute, value) {
      var S = toString3(requireObjectCoercible2(string));
      var p1 = "<" + tag;
      if (attribute !== "")
        p1 += " " + attribute + '="' + replace3(toString3(value), quot, "&quot;") + '"';
      return p1 + ">" + S + "</" + tag + ">";
    };
  }
});
...
var FORCED2 = !DESCRIPTORS || fails3(function() {
...
$5({ target: "Object", stat: true, forced: FAILS_ON_PRIMITIVES2, sham: !CORRECT_PROTOTYPE_GETTER }, {
...
$6({ target: "Reflect", stat: true, forced: FORCED3, sham: FORCED3 }, {
...
var repeat = uncurryThis3($repeat);
var stringSlice2 = uncurryThis3("".slice);
var nativeToFixed = uncurryThis3(1 .toFixed);
...
$7({ target: "Number", proto: true, forced: FORCED4 }, {
...
$8({ target: "String", proto: true, forced: forcedStringHTMLMethod("bold") }, {
  bold: function bold() {
...
var exec = uncurryThis4(RegExpPrototype2.exec);
...
var BASE_FORCED = DESCRIPTORS2 && (!CORRECT_NEW || MISSED_STICKY || UNSUPPORTED_DOT_ALL || UNSUPPORTED_NCG || fails8(function() {
  re2[MATCH] = false;
    ...
    if (chr === "\\") {
      ...
      switch (true) {
        case chr === "[":
          ...
          break;
        case chr === "(":
          if (exec(IS_NCG, stringSlice3(string, index + 1))) {
            index += 2;
            ncg = true;
          }
          result += chr;
...
if (isForced("RegExp", BASE_FORCED)) {
  RegExpWrapper = function RegExp2(pattern, flags) {
    var thisIsRegExp = isPrototypeOf(RegExpPrototype2, this);
    ...
    if (patternIsRegExp || isPrototypeOf(RegExpPrototype2, pattern)) {
    ...
    result = inheritIfRequired(NativeRegExp(pattern, flags), thisIsRegExp ? this : RegExpPrototype2, RegExpWrapper);
  ...
  for (keys = getOwnPropertyNames2(NativeRegExp), index = 0; keys.length > index; ) {
    proxyAccessor(RegExpWrapper, NativeRegExp, keys[index++]);
  }
  RegExpPrototype2.constructor = RegExpWrapper;
  RegExpWrapper.prototype = RegExpPrototype2;
  defineBuiltIn2(global2, "RegExp", RegExpWrapper, { constructor: true });
}
var RegExpWrapper;
var keys;
var index;
...
function delimit(type) {
  return trim2(slice(position - 1, delimiter(type === 91 ? type + 2 : type === 40 ? type + 1 : type)));
}
...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length2) {
  ...
  for (var i = 0, j = 0, k2 = 0; i < index; ++i) {
    for (var x2 = 0, y2 = substr(value, post + 1, post = abs(j = points[i])), z2 = value; x2 < size; ++x2) {
      if (z2 = trim2(j > 0 ? rule[x2] + " " + y2 : replace2(y2, /&\f/g, rule[x2])))
        props[k2++] = z2;
    }
  }
...
function hoistNonReactStatics$2(targetComponent, sourceComponent, blacklist) {
  if (typeof sourceComponent !== "string") {
    ...
    var keys = getOwnPropertyNames3(sourceComponent);
...
var useInsertionEffect$2 = React["useInsertionEffect"] ? React["useInsertionEffect"] : function useInsertionEffect2(create4) {
  create4();
};
function useInsertionEffectMaybe$1(create4) {
  if (!isBrowser$1$1) {
    return create4();
  }
  useInsertionEffect$2(create4);
}
...
var useInsertionEffect3 = React["useInsertionEffect"] ? React["useInsertionEffect"] : function useInsertionEffect4(create4) {
  create4();
};
...
var isColorString = function isColorString2(color2) {
  if (typeof color2 !== "string") {
    import_client_logger.logger.warn("Color passed to theme object should be a string. Instead " + "".concat(color2, "(").concat(_typeof(color2), ") was passed."));
    return false;
  }
  return true;
};
...
var create2 = function create3(_ref7) {
...
var isObject2 = function isObject3(o) {
...
var deletedDiff = function deletedDiff2(lhs, rhs) {
  if (lhs === rhs || !isObject2(lhs) || !isObject2(rhs))
    return {};
  var l2 = lhs;
  var r2 = rhs;
  return Object.keys(l2).reduce(function(acc, key) {
    if (hasOwnProperty(r2, key)) {
      ...
      if (isObject2(difference) && isEmpty(difference))
        return acc;
      acc[key] = difference;
      return acc;
    }
...
var ensure = function ensure2(input) {
  ...
  if (Object.keys(missing).length) {
    import_client_logger.logger.warn(dedent(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n          Your theme is missing properties, you should update your theme!\n\n          theme-data missing:\n        "]))), missing);
  }
