import {
  instrument
} from "./chunk-BVNHFFX2.js";
import "./chunk-FNETN2WE.js";
import {
  require_is_regex,
  require_is_symbol,
...
testingLibrary.screen = Object.entries(testingLibrary.screen).reduce(function(acc, _a) {
  ...
  return Object.defineProperty(acc, key, {
    get: function() {
      import_client_logger.once.warn(esm_default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n          You are using Testing Library's `screen` object. Use `within(canvasElement)` instead.\n          More info: https://storybook.js.org/docs/react/essentials/interactions\n        "], ["\n          You are using Testing Library's \\`screen\\` object. Use \\`within(canvasElement)\\` instead.\n          More info: https://storybook.js.org/docs/react/essentials/interactions\n        "]))));
      return val;
    }
  });
