...
// ../../node_modules/@storybook/blocks/node_modules/@storybook/components/dist/chunk-E5IOH6B7.mjs
...
var ArrowSpacing = 8;
var Arrow = emotion_styled_browser_esm_default.div({ position: "absolute", borderStyle: "solid" }, ({ placement }) => {
  let x = 0, y = 0;
  switch (true) {
...
var Wrapper = emotion_styled_browser_esm_default.div(({ hidden }) => ({ display: hidden ? "none" : "inline-block", zIndex: 2147483647 }), ({ theme, color, hasChrome }) => hasChrome ? { background: theme.color[color] || color || theme.base === "light" ? lightenColor(theme.background.app) : theme.background.app, filter: `
...
var WithTooltipPure = ({ svg, trigger, closeOnOutsideClick, placement, hasChrome, withArrows, offset: offset2, tooltip, children, closeOnTriggerHidden, mutationObserverOptions, closeOnClick, tooltipShown, onVisibilityChange, defaultVisible, delayHide, visible, interactive, delayShow, modifiers, strategy, followCursor, onVisibleChange, ...props }) => {
  let Container = svg ? TargetSvgContainer : TargetContainer, { getArrowProps, getTooltipProps, setTooltipRef, setTriggerRef, visible: isVisible, state } = usePopperTooltip({ trigger, placement, defaultVisible: defaultVisible != null ? defaultVisible : tooltipShown, delayHide, interactive, closeOnOutsideClick: closeOnOutsideClick != null ? closeOnOutsideClick : closeOnClick, closeOnTriggerHidden, onVisibleChange: (_isVisible) => {
...
//# sourceMappingURL=chunk-ZLQBRHHW.js.map
